...
from backend.utils.transliteration import transliteration_rus_eng as t_
from rest_framework.exceptions import ValidationError


def create_path(instance, filename):
    """Определение пути сохранения изображения"""
    return '{}/{}/{}'.format(instance.__class__.__name__.lower(), t_(instance), filename)
...
class AbstractImageModel(models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.min_height = kwargs.get('min_height', 310)
        self.min_width = kwargs.get('min_width', 310)
